...
public static class IdGenerator
{
    ...
    private static readonly Dictionary<object, Dictionary<string, string>> _idMappings = new();
    private static readonly Dictionary<object, Dictionary<string, int>> _counter = new();
